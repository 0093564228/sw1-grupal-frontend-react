      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
              ...
              <div className="absolute top-1/2 right-0 transform translate-x-8 -translate-y-1/2">
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M17.316 6.246c.088-.66.176-1.32.176-2.065 0-1.14-.292-1.292-1.049-1.292-.716 0-1.37.392-1.37 1.292 0 .164.015.33.03.495l-1.12-1.12a3.964 3.964 0 00-2.786-1.133c-1.488 0-2.716.716-3.4 1.8-.342.54-.54 1.152-.54 1.8 0 .648.198 1.292.54 1.8.684 1.084 1.912 1.8 3.4 1.8.648 0 1.26-.198 1.8-.54l1.12 1.12c-.165-.015-.33-.03-.495-.03-.9 0-1.292.654-1.292 1.37 0 .757.152 1.049 1.292 1.049.745 0 1.405-.088 2.065-.176l.246.246c.088.66.176 1.32.176 2.065 0 1.14-.292 1.292-1.049 1.292-.716 0-1.37-.392-1.37-1.292 0-.164.015-.33.03-.495l1.12 1.12c.54-.342 1.152-.54 1.8-.54.648 0 1.26.198 1.8.54l1.12-1.12c-.165.015-.33.03-.495.03-.9 0-1.292-.654-1.292-1.37 0-.757-.152-1.049-1.292-1.049-.745 0-1.405.088-2.065.176l-.246-.246z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
          ...
          <div className="bg-gray-800 rounded-lg p-8">
            ...
            <div className="flex justify-end mb-6 space-x-4">
              ...
              <div className="bg-gray-700 rounded-lg px-4 py-2 flex items-center space-x-2">
                ...
                {/* Spacer placeholder for arrow if needed */}
              </div>
            </div>
        ...
        <div className="text-center">
          <h3 className="text-white text-lg font-medium mb-6">
            ¿Sin audio? Prueba con uno de estos
          </h3>
          <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="bg-gray-800 rounded-lg p-3 text-center shadow-lg"
              >
                <div
                  className={`w-full h-20 bg-gradient-to-br ${sample.bg} rounded mb-2 flex items-center justify-center`}
                >
